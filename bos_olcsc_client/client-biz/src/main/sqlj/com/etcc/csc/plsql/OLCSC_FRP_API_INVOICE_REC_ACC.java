...
public class OLCSC_FRP_API_INVOICE_REC_ACC implements ORAData, ORADataFactory
{
  ...
  protected ORAData create(OLCSC_FRP_API_INVOICE_REC_ACC o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new OLCSC_FRP_API_INVOICE_REC_ACC();
  ...
  { _struct.setAttribute(4, DUE_DATE); }
  ...
  { _struct.setAttribute(6, AGENCY_NAME); }
  ...
  { _struct.setAttribute(11, INVOICE_AMT); }
  ...
  { _struct.setAttribute(12, AMOUNT_PAID); }
  ...
  { _struct.setAttribute(13, AMOUNT_PENDING); }
  ...
  { _struct.setAttribute(14, AMOUNT_OWED); }
  ...
  { _struct.setAttribute(15, AMOUNT_FOR_NEW_PMT); }
  ...
  { _struct.setAttribute(16, PAYMENT_MADE_ONLINE); }

  public String toString()
  { try {
     return "OL_OWNER.OLCSC_FRP_API_INVOICE_REC_ACC" + "(" +
