...
public class OLCSC_INV_VPS_INVOICE_REC implements ORAData, ORADataFactory
{
  ...
  protected ORAData create(OLCSC_INV_VPS_INVOICE_REC o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new OLCSC_INV_VPS_INVOICE_REC();
  ...
  { _struct.setAttribute(4, TOLL_AMT); }
  ...
  { _struct.setAttribute(5, ADMIN_FEES); }
  ...
  { _struct.setAttribute(6, COLLECTION_FEES); }
  ...
  { _struct.setAttribute(7, OTHER_FEES); }
  ...
  { _struct.setAttribute(8, INVOICE_AMT); }
  ...
  { try {
     return "OL_OWNER.OLCSC_INV_VPS_INVOICE_REC" + "(" +
