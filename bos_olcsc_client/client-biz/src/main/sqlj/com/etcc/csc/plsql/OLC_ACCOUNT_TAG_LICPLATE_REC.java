...
public class OLC_ACCOUNT_TAG_LICPLATE_REC implements ORAData, ORADataFactory
{
  ...
  { _init_struct(true);
    ...
    setACCOUNT_TAG_ID(ACCOUNT_TAG_ID);
  }
  ...
  protected ORAData create(OLC_ACCOUNT_TAG_LICPLATE_REC o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new OLC_ACCOUNT_TAG_LICPLATE_REC();
  ...
  public java.math.BigDecimal getACCOUNT_TAG_ID() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(24); }

  public void setACCOUNT_TAG_ID(java.math.BigDecimal ACCOUNT_TAG_ID) throws SQLException
  { _struct.setAttribute(24, ACCOUNT_TAG_ID); }

  public String toString()
  { try {
     return "OL_OWNER.OLC_ACCOUNT_TAG_LICPLATE_REC" + "(" +
       getACCT_TAG_SEQ() + "," +
