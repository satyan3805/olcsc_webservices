...
public class OLC_UNINVOICED_VIOLS_REC implements ORAData, ORADataFactory
{
  ...
  protected ORAData create(OLC_UNINVOICED_VIOLS_REC o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new OLC_UNINVOICED_VIOLS_REC();
  ...
  { try {
     return "OL_OWNER.OLC_UNINVOICED_VIOLS_REC" + "(" +
       getVIOLATION_ID() + "," +
