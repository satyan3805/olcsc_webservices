...
public class OLC_VPS_INV_REC_N implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "OL_OWNER.OLC_VPS_INV_REC_N";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 12,91,91,12,2,2,2,2,2,2,2,2,2,2,2003,12 };
  protected static ORADataFactory[] _factory = new ORADataFactory[16];
  static
  {
    _factory[14] = OLC_VPS_INV_ARR_D.getORADataFactory();
  }
  protected static final OLC_VPS_INV_REC_N _OLC_VPS_INV_REC_NFactory = new OLC_VPS_INV_REC_N();

  public static ORADataFactory getORADataFactory()
  { return _OLC_VPS_INV_REC_NFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[16], _sqlType, _factory); }
  public OLC_VPS_INV_REC_N()
  { _init_struct(true); }
  ...
  protected ORAData create(OLC_VPS_INV_REC_N o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new OLC_VPS_INV_REC_N();
  ...
  { _struct.setAttribute(15, AGENCY_NAME); }

  public String toString()
  { try {
     return "OL_OWNER.OLC_VPS_INV_REC_N" + "(" +
