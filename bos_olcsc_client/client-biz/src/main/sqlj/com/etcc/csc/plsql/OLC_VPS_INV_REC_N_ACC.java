...
public class OLC_VPS_INV_REC_N_ACC implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "OL_OWNER.OLC_VPS_INV_REC_N_ACC";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 12,91,91,12,12,12,2,2,2,2,2,2,2,2,2,2,2003,12 };
  protected static ORADataFactory[] _factory = new ORADataFactory[18];
  static
  {
    _factory[16] = OLC_VPS_INV_ARR_D.getORADataFactory();
  }
  protected static final OLC_VPS_INV_REC_N_ACC _OLC_VPS_INV_REC_N_ACCFactory = new OLC_VPS_INV_REC_N_ACC();

  public static ORADataFactory getORADataFactory()
  { return _OLC_VPS_INV_REC_N_ACCFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[18], _sqlType, _factory); }
  public OLC_VPS_INV_REC_N_ACC()
  { _init_struct(true); }
  public OLC_VPS_INV_REC_N_ACC(String INVOICE_ID, java.sql.Timestamp INVOICE_DATE, java.sql.Timestamp DUE_DATE, String AGENCY_ID, String LIC_PLATE, String LIC_STATE, java.math.BigDecimal INVOICE_AMOUNT, java.math.BigDecimal TOLL_AMT, java.math.BigDecimal ADMIN_FEES, java.math.BigDecimal COLLECTION_FEES, java.math.BigDecimal OTHER_FEES, java.math.BigDecimal AMOUNT_PAID, java.math.BigDecimal AMOUNT_PENDING, java.math.BigDecimal AMOUNT_OWED, java.math.BigDecimal AMOUNT_FOR_NEW_PMT, java.math.BigDecimal PAYMENT_MADE_ONLINE, OLC_VPS_INV_ARR_D LINE_ITEMS, String AGENCY_NAME) throws SQLException
  { _init_struct(true);
  ...
  protected ORAData create(OLC_VPS_INV_REC_N_ACC o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new OLC_VPS_INV_REC_N_ACC();
  ...
  { _struct.setAttribute(4, LIC_PLATE); }
  ...
  { _struct.setAttribute(5, LIC_STATE); }
  ...
  { _struct.setAttribute(6, INVOICE_AMOUNT); }
  ...
  { _struct.setAttribute(7, TOLL_AMT); }
  ...
  { _struct.setAttribute(8, ADMIN_FEES); }
  ...
  { _struct.setAttribute(9, COLLECTION_FEES); }
  ...
  { _struct.setAttribute(10, OTHER_FEES); }
  ...
  { _struct.setAttribute(11, AMOUNT_PAID); }
  ...
  { _struct.setAttribute(12, AMOUNT_PENDING); }
  ...
  { _struct.setAttribute(13, AMOUNT_OWED); }
  ...
  { _struct.setAttribute(14, AMOUNT_FOR_NEW_PMT); }
  ...
  { _struct.setAttribute(17, AGENCY_NAME); }

  public String toString()
  { try {
     return "OL_OWNER.OLC_VPS_INV_REC_N_ACC" + "(" +
