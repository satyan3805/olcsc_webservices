...
<head>
	<title>EZ Agreement &mdash; Harris County Toll Road Authority</title>
	...
	<div id="content-container">
		...
		<div id="content">
			...
			<dl class="introduction">
				<dt>Please retain this agreement for your records. Visit our Online EZ TAG Store at <a href="${appDelegate.domainName}">HCTRA.org</a>.</dt>
					...
					<dd class="pdf"><a href="${appDelegate.domainName}/file_download/20/EZ+Agreement+Form.pdf">Download a PDF version</a></dd>
                        ...
                        ${tagDelegate.tagApplicationAgreement}
