...
<div id="content-container">
	...
	<div id="content">
                ...
                <form id="payment" action="${pageContext.request.contextPath}/violationPaymentMethod.do" method="post" autocomplete="off">
                        ...
                        <c:if test="${selectedInvoiceForm.billingInfoForm.paymentType=='credit'}">
...
<%@ include file="violator-totals.jsp" %>
          ...
          >${cc.cardName}</option>
							...
							<dt><label for="card-number" id="for-card-number">Card Number:</label></dt>
								<dd>*<input type="text" class="textfield" id="card-number" name="billingInfoForm.cardNumber" value="${selectedInvoiceForm.billingInfoForm.cardNumber}" /></dd>
				...
				<!-- This contains the elements common to both the credit-card and withdraw-funds choices -->
                                <div id="common-section" class="common section" <c:if test="${changePayMethod or (empty selectedInvoiceForm.billingInfoForm) or (empty selectedInvoiceForm.billingInfoForm.paymentType)}"> style="display:none" </c:if>>
								...
								<dd class="non-us first-dt-dd-pair" id="country-dd">
                                                                <select id="country" name="billingInfoForm.country">
                                                                    ...
                                                                    <c:forEach var="country" items="${countryDelegate.countries}">
                                                                        ...
                                                                        <c:if test="${country.countryCode == selectedInvoiceForm.billingInfoForm.country}">
                                                                            selected
                                                                        </c:if>
                                                                        >
