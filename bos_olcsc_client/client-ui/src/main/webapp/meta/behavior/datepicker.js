/*
        DatePicker v2.3 by frequency-decoder.com (2006/11/06)
...
function datePicker(options) {
        ...
        o.resize = function() {
                ...
                if ( parseInt(document.documentElement.clientWidth+document.documentElement.scrollLeft) < parseInt(osw+pos[0])) {
                        o.div.style.left = parseInt((document.documentElement.clientWidth+document.documentElement.scrollLeft) - osw) + "px";
                } else {
                        o.div.style.left  = pos[0] + "px";
                }

                if ( parseInt(document.documentElement.clientHeight+document.documentElement.scrollTop) < parseInt(osh+pos[1]+elem.offsetHeight+2)) {
                        o.div.style.top   = parseInt(pos[1] - (osh + 2)) + "px";
                } else {
                        o.div.style.top   = parseInt(pos[1] + elem.offsetHeight + 2) + "px";
                }
        };
        ...
        o.returnFormattedDate = function() {
                ...
                if(!(o.disableDays[weekDay])) {
                        if(o.splitDate) {
                                ...
                                var elemId = elem.id;
                                if (elemId.indexOf("Time")!=-1)
                                    elem.value = elem.value + " 00:00:00";
//                                alert(elem.value);
                                elem.focus();
                        }
        ...
        o.show = function() {
                ...
                // Dumbass Internet Explorer requires the keydown event in order to catch arrow keys
