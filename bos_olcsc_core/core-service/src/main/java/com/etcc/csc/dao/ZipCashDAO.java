...
public abstract class ZipCashDAO extends BaseDAO {
	...
	public abstract PaymentResponse zipCashCombinedPayment(long acctId,
			long docId, String docType, String dbSessionId, String ipAddress,
	...
	public abstract OlcPaymentInfoRec getPaymentInfo(BigDecimal docId,
			...
			String loginId, long event) throws EtccErrorMessageException,
			Exception;
