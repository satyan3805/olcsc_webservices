...
<HTML>
<HEAD>
<title><fmt:message key="title.ntta.tagstore"/>: <fmt:message key="title.tagstore"/></title>
...
<script language="javascript">
 ...
 var title= "<fmt:message key="title.tagstore"/>"
 </script>
...
var v_ret = "";
    ...
    if (v_ret.length != 8) {
	 	alert('<fmt:message key="app.errorpage.tab.title"/>:\n<fmt:message key="getTolltag.agreement.driverLicense.error"/>');
	 	e.focus();
	 	return false;
    }
    else {
...
if ( document.regform.p_acct_id.value == "" ) {
  alert('<fmt:message key="app.errorpage.tab.title"/> - <fmt:message key="error.tagstore.accnum"/>');
  document.regform.p_acct_id.focus(); return false; 
} 
if ( document.regform.p_tag_nbr.value == "" ) {
  alert('<fmt:message key="app.errorpage.tab.title"/> - <fmt:message key="error.tagstore.tagnum"/>');
  document.regform.p_tag_nbr.focus(); return false; 
} 
if ((document.regform.p_driver_lic_nbr.value == "") && (document.regform.p_tax_id.value == "")) {
  alert('<fmt:message key="app.errorpage.tab.title"/> - <fmt:message key="error.tagstore.dlortaxid"/>'); 
...
class="links"
href="/webcust/tt_front_page_publish"><fmt:message key="label.home.tolltag"/></a>&nbsp;<br></td>
  </tr>
