        ...
        <td>
            <table cellspacing="0" class="datapayment" width="100%">
              <tr>
                ...
                <td style="text-align:right; width:80px;"><strong><fmt:formatNumber value="${sessionScope.ZIPCASH_PAYMENT_CONTEXT.paymentAmount}"  currencySymbol="$" type="currency"/></strong></td>
              </tr>
            </table>
        </td>
    </tr>
